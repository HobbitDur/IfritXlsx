...
def pack(source_path, dest_path, lang="eng", remaster=False):
    ...
    if remaster:
        ...
        compression = "lzs"
    subprocess.run(["Resources/ArchiveManagementCLI/deling-cli.exe", "import", "-c", compression, source_path, os.path.join(dest_path,"battle.fs"), "-f", "--prefix", 'c:\\ff8\\data\\'+lang+'\\battle\\'])
